...
class Todo extends React.Component {
    state = {
        elements: [
            {id: '12345', isComplited: false, title: 'Feed dog'},
            {id: '12346', isComplited: true, title: 'Do shopping'}
        ],
        inputValue: ''
    }
    ...
    render () {
        ...
        return (
            <div>
                Todo app
                <input type="text" value={this.state.inputValue} onChange={this.inputHandler.bind(this)}></input>
